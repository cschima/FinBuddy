...
class CardPagerAdapter(private val context: Context, private val emptyTextView: TextView? = null) : RecyclerView.Adapter<CardPagerAdapter.MyHolder>(), CardAdapter {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        if (goalCard.isFlexible()){
            ...
            holder.timeLeftText.text = context.getString(R.string.value_left, goalCard.getTimeLeft())
            holder.tryToSaveText.text = context.getString(R.string.try_to_save)
            holder.savingsNeeded.text = context.getString(R.string.dollar_value, goalCard.getSavingsNeeded())
        }
        holder.title.text = goalCard.getTitle()
        holder.currentAmount.text = context.getString(R.string.dollar_value, goalCard.getCurrentAmount())
